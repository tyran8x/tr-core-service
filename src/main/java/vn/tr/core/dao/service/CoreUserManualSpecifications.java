...
public class CoreUserManualSpecifications {

	private CoreUserManualSpecifications() {

	}

	public static Specification<CoreUserManual> quickSearch(final String search, final Boolean trangThai, final List<String> maUngDungs,
