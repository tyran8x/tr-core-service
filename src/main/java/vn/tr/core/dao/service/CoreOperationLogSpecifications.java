...
public class CoreOperationLogSpecifications {

	private CoreOperationLogSpecifications() {

	}

	public static Specification<CoreOperationLog> quickSearch(final String search, final Boolean trangThai, final String appCode) {
