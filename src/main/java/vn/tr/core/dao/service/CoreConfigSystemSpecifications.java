...
class CoreConfigSystemSpecifications {
	
	private CoreConfigSystemSpecifications() {

	}

	public static Specification<CoreConfigSystem> quickSearch(final String maUngDung, final String code, final Boolean trangThai) {
