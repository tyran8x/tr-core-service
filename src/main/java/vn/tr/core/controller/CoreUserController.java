...
/**
 * Controller quản lý toàn bộ các nghiệp vụ liên quan đến Người dùng (CoreUser).
 * Tận dụng @AppCode Argument Resolver để tự động hóa việc xác định ngữ cảnh ứng
 * dụng.
 *
 * @author tyran8x
 * @version 3.0
...
public class CoreUserController {
     ...
     * @param appCode Ngữ cảnh ứng dụng, được resolver điền. Super Admin có thể
     * chỉ định qua body.
     *
     ...
     *
     * @param id ID của người dùng.
     * @param appCode Ngữ cảnh ứng dụng. App Admin chỉ có thể xem user trong app
     * của mình.
     *
...
//		}
    ...
    public R<CoreUserData> getCurrentUser() {
        ...
        CoreUserData coreUserData = coreUserBusiness.findById(Long.valueOf(loginUser.getUserId()), null);
        return R.ok(coreUserData);
    }
    ...
    /**
     * Cập nhật (đồng bộ hóa) toàn bộ cây workspace của người dùng đang đăng
     * nhập.
     *
