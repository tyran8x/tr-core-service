...
public class CoreUserBusiness {
	...
	public Page<CoreUserData> findAll(int page, int size, String sortBy, String sortDir, String email, String name, List<Long> roleIds,
			String appCode) {
		Pageable pageable = CoreUtils.getPageRequest(page, size, sortBy, sortDir);
		Page<CoreUser> pageCoreUser = coreUserService.findAll(email, name, roleIds, appCode, pageable);
