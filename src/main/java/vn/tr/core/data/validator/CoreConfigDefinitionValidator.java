...
/**
 * Validator tùy chỉnh cho CoreConfigDefinitionData.
 * Chịu trách nhiệm kiểm tra các quy tắc nghiệp vụ như sự trùng lặp của `key`
 * trong ngữ cảnh của một ứng dụng (appCode).
 *
 * @author tyran8x
 * @version 2.0
 */
...
public class CoreConfigDefinitionValidator implements Validator {
	 ...
	 *
	 * @param target Đối tượng cần validate (dự kiến là CoreConfigDefinitionData).
